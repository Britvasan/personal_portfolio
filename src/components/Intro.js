    ...
    <section className='flex flex-col md:flex-row px-5 py-32 bg-primary justify-center'>
      <div className='md:w-1/2 flex flex-col'>
        ...
        <div className='flex py-10'>
          <a href={config.social.twitter} target='_blank' rel="noopener noreferrer" className='pr-5 hover:text-white'><AiOutlineTwitter size={40}/></a>
          <a href={config.social.facebook} target='_blank' rel="noopener noreferrer" className='pr-5 hover:text-white'><AiOutlineFacebook size={40}/></a>
          ...
          <a href={config.social.instagram} target='_blank' rel="noopener noreferrer" className='pr-5 hover:text-white'><AiOutlineInstagram size={40}/></a>
          <a href={config.social.github} target='_blank' rel="noopener noreferrer" className='hover:text-white'><AiOutlineGithub size={40}/></a>
        </div>
      </div>
      <img className='md:w-1/3' src={IntroImg} alt='hero preview' />
    </section>
  )
}
